...
其中ANTHROPIC_AUTH_TOKEN 填写在后台获取以sk-的APIKEY,ANTHROPIC_MODEL填写需要使用的模型。目前我们支持了所有模型使用claude格式进行调用。例如需要调用gemini-2.5-pro,只需将kimi-k2-0711-preview替换为gemini-2.5-pro即可，不局限于Claude的模型
