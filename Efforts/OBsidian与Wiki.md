...
- [ ] Wikilink 禁止清单(系统文件不存 wikilink)
- [ ] Wiki 语言规范(中文写作，英文 slug、aliases 跨语言)
- [ ] 系统文件隔离规则(graph - excluded: true)
- [ ] 文件维护规则(CLAUDE.md 更新同步 USER_GUIDE.md)
...
- [ ] wiki/overview.md graph-excluded: true
- [ ] wiki/QUESTIONS.md graph-excluded: true
      
## 五、scripts/lint.py 检查项（验证是否包含全部9项）
