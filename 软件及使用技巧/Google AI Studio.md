...
![](../file-20251202095028610.png)
# 简介及界面
![](../file-20251202095503756.png)
# 参数设置
## 基础参数配置

### 模型选择
![500](../file-20251202101300576.png)

### 系统指令
全局系统提示词，可以把个人的喜好和信息全部写进去

![](../file-20251202100401553.png)
### 计费状态
免费版不用管
### 提示词温度
使用Gemini3强烈建议设为1
![](../file-20251202102023221.png)
#### Temperature和Top-p原理
这两个参数都是用来控制大模型回答的答案的随机性和创造力的。
![](../file-20251201102528384.png)
##### 生成分数
![](../file-20251201102907920.png)
![](../file-20251201102932070.png)
##### 转换概率
![](../file-20251201103252894.png)
![](../file-20251201103320110.png)
##### 加权采样

![](../file-20251201112828410.png)
##### Temperature
![](../file-20251201113027918.png)
![](../file-20251201113455661.png)
##### Top-p
![](../file-20251201113619975.png)
![](../file-20251201113700660.png)
![](../file-20251201113856131.png)
### 媒体分辨率
大部分情况下保持默认值
...
![](../file-20251204153034415.png)
![](../file-20251204153100996.png)