...
#### Step 2. Install  安装
![](../file-20251206201538656%201.png)
如果出现提示信息
![](../file-20251206201538655%201.png)
1. Click **"More Info"**  
    点击 **“更多信息”**
2. Then click **"Run anyway"**  
    然后点击 **“仍然运行”。**
![](../file-20251206201538656.png)
# Quickstart  快速入门
Pinokio 是一个独立的平台，允许您以隔离的方式安装应用程序。
你可以浏览主页上你感兴趣的软件一键部署
![](../file-20251206201538623.png)
你也可以按照教程部署Github上的项目。
![](../file-20251206201538624.png)
...
![](../file-20251206201538624%201.png)
[conda是什么](conda是什么.md)
![](../file-20251206201538622%202.png)![](../file-20251206201538622%201.png)![](../file-20251206201538622.png)![](../file-20251206201538621.png)
...
5. `logs` ：存储每个应用程序的所有日志文件。![](../file-20251206201538641%201.png)
安装卡顿在这个状态
![](../file-20251207102222023.png)
