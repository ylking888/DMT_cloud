...
![](../附件/file-20251201172715716.png)
它这个模型是一组不是一个
![](../附件/file-20251201172842799.png)
...
![](../附件/file-20251201175845363.png)
在弹出的浏览器页面中拖入示例
![](../附件/file-20251201180016751.png)
![](../附件/file-20251201180035476.png)
提示缺少这些文件。
首先是下载主模型
