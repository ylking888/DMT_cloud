...
在命令行调用
![](assets/API中转站302.ai/file-20260428123013531.png)
在VS Code中调用
![](assets/API中转站302.ai/file-20260428122944026.png)
## 使用302cc设置
### 全局安装
```
npm install -g 302cc 
...
> 1. 配置 API Key
  ...
  7. 直接退出
```
![](assets/API中转站302.ai/file-20260428144040208.png)
