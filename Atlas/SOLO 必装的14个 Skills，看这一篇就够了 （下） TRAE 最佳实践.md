...
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323805%201.png)
## frontend-design
### 作者Anthropics
### 简介
...
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323805.png)
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323804%201.png)
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323804.png)
使用 “frontend-design” 技能后：
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323803.png)
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323802%201.png)
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323802.png)
## frontend-skill
### 作者OpenAI
### 简介
...
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323801%201.png)
使用 “frontend-skill” 技能后：![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323801.png)
哪个前端设计 skill 更适合我？
...
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323800.png)
### 使用案例二：
- 提示词：
```
...
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323799.png)
## data-analysis
### 作者ByteDance
### 简介
...
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323798.png)
AI 调用 “data-analysis” 技能后的分析结果，经人工核算，AI 提供的数据完全准确。
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323780.png)
## 三、内容创作
## canvas-design
### 作者Anthropics
### 简介
...
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323778.png)
- AI 生成的海报：
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323777.png)
### 使用案例二：
- 提示词：
```
...
```
- AI 使用 “canvas-design” 技能后的输出：
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323776.png)
- AI 生成的明信片：
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323775.png)
...
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323774.png)
## doc-coauthoring
### 作者Anthropics
### 简介
...
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323773.png)
2. 第二阶段：分块起草与细化
在这个阶段，AI 负责搭骨架和提供选项，我负责做决定。 AI 起草了 prd.md 的核心大纲（产品概述、用户权限、核心流程等）。针对复杂的业务逻辑（比如扣费时机、prompt 怎么拼、模型选哪些），AI 没有直接写死，而是列出了不同的方案，让我来做决策。这保证了 PRD 是真正按照我的意志来编写的。![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323771.png)
3. 第三阶段：读者视角测试
...
![](assets/SOLO%20必装的14个%20Skills，看这一篇就够了%20（下）%20TRAE%20最佳实践/file-20260422094323765.png)
